# Operator Quickstart — Community Medical Device Manufacturing

Shortest path from clone to a verified local dry-run for **ISIC 2660** (`cloud-itonami-isic-2660`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-2660.git
cd cloud-itonami-isic-2660
```
...
- Blueprint governor key: `medical-device-governor`
- Likely source path: `medicaldevice.governor.cljc`
